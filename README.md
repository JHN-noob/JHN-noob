...
## About
- 전공 : B.S in Computer Science | M.S Student in AI-based Convergence
...
- `Parameter-Efficient Video Object Detection: Comparing Temporal Adapters for RT-DETR and YOLO`
  - RT-DETR 및 YOLO 기반 Temporal Adapter에서 비디오 객체 탐지 PEFT 성능, 효율성, 시공간 적응성, 프레임별 탐지 안정성 분석
