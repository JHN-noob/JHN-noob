### 안녕하세요, 👋 나재현입니다.
컴퓨터공학을 전공하였고 인공지능·딥러닝을 공부하고 있습니다.
<br>
...
- `Parameter-Efficient Adaptation for Video Object Detection: Comparing Transformer-based and YOLO with Temporal Adapters`
  - TransVOD vs YOLO + Temporal Adapter 기반 동영상 객체탐지에서 PEFT 성능, 효율, 공간축/시간축 적응 효과, 프레임별 탐지 안정성 분석
...
### BabRadar(In Progress)
- 사용자 위치 기반 주변 식당 검색과 AI 추천 기능을 결합, 근처에서 바로 갈 만한 맛집을 빠르게 찾도록 설계한 모바일 앱
